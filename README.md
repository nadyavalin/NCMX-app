...
__NCMX-app__ — это веб-приложение ведения реестра несоответствий, наблюдений и возможностей для улучшения, добавления комментариев к ним, сохранения истории комментариев, отслеживания сроков выполнения, закрытия несоответствий с оценкой, переноса в архив после закрытия.

#### Что реализовано из функционала (без учёта UI):
- реализовано добавление несоответствий и комментариев к ним.

#### Что планируется реализовать:
- улучшить функционал модального окна для добавления несоответствий с учётом практических данных;
- реализовать добавления наблюдений и комментариев к ним;
- реализовать добавление возможностей для улучшения и комментариев к ним;
- реализовать добавления закрытых несоответствий, наблюдений, возможностей для улучшения в архив;
- настроить управление пользователями, чтобы они могли при входи в систему автоматически (по логину/паролю системы) попадать в данное приложение с целью внесения комментариев к несоответствию, наблюдение, возможности для улучшения своего подразделения;
- настроить систему оповещения в случае, если срок реализации коррекции/корректирующего действия подходит к концу.
