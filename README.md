...
#### Что реализовано из функционала:

- добавление, изменение, удаление несоответствий;
- добавление, изменение, удаление комментариев к несоответствиям;
- возможность просмотра истории комментариев;
- оценка и перенос несоответствия в архив;
- архив закрытых несоответствий;
- добавлен UI для фильтрации и поиска;

#### Что планируется реализовать в ближайшее время:

- улучшить UI и функционал модального окна для добавления несоответствий;
- масштабировать решение на наблюдения и возможности для улучшения;
- масштабировать решение на несоответствия и наблюдения внешних аудитов;
- улучшить навигацию в header для отображения items для внешних и внутренних аудитов;
- сделать функционал для фильтрации и поиска;
- сделать авторизацию через систему пользователя (управление пользователями, чтобы они могли при входе в систему автоматически (по логину/паролю системы) попадать в данное приложение);
-
