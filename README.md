...
- реализовать валидацию полей во всех формах;
...
- реализовать архивацию закрытых записей;
- настроить управление пользователями, чтобы они могли при входе в систему автоматически (по логину/паролю системы) попадать в данное приложение с целью внесения комментариев к несоответствию, наблюдение, возможности для улучшения своего подразделения;
- настроить систему оповещения в случае, если срок реализации коррекции/корректирующего действия подходит к концу;
- реализовать расширенные фильтры и поиск;
- реализовать дашборд с визуализацией количества несоответствий, наблюдений и предложений по подразделениям и статусам;
- реализовать историю изменений;
- оптимизировать интерфейс для мобильных устройств;
- настроить экспорт данных в Excel/PDF;
